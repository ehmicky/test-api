...
export const start = async (startData, { _allTasks: allTasks }) => {
...
const stringifyDefinition = (task) => {
  const definition = getDefinition(task)
  return JSON.stringify(definition)
}

const getDefinition = ({ spec: { definition } = {} }) => definition
