...
// Run each `plugin.run()`
export const runTask = async ({ task, context, plugins, nestedPath }) => {
...
const getContext = ({ context, plugins, nestedPath }) => {
...
const checkRecursion = ({ nestedPath = [], key, self }) => {
...
const appendNestedPath = ({ nestedPath = [], key, self }) => {
...
const throwRecursiveError = ({ task, error, getError }) => {
